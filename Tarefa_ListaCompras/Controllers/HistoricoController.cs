...
public sealed class HistoricoController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateAsync([FromBody] HistoricoRequestDto request)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> UpdateAsync(int id, [FromBody] HistoricoRequestDto request)
    {
