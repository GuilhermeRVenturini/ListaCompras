...
public sealed class StatusController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateAsync([FromBody] StatusRequestDto request)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> UpdateAsync(int id, [FromBody] StatusRequestDto request)
    {
